...
class CommNetMLP(nn.Module):
    ...
    def __init__(self, args, num_inputs):
        ...
        for l,p in self.named_parameters():
            if l=='value_global.weight' or l=='value_global.bias' :
                continue
            else:
    ...
    def forward(self, x, info={}):
        ...
        # value_global = self.value_global(torch.cat((hidden_state,c), dim=1)).sum(1).view(value_head.shape[0],1)
